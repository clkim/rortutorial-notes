...
5.3.1 Route tests
  * I had done exercise #2 in Chap 3, Section 3.5. So, Listing 5.15 and Listing 5.19 should be <pre>text: "#{base_title} | Contact"</pre>  instead of  <pre>text: "Ruby on Rails Tutorial Sample App | Contact"</pre> 