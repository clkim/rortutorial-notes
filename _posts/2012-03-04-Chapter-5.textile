...
5.3.1 Route tests
* I had done exercise #2 in Chapter 3, Section 3.5. So, Listing 5.15 and Listing 5.19 would be <pre>text: "#{base_title} | Contact"</pre>  instead of  <pre>text: "Ruby on Rails Tutorial Sample App | Contact"</pre>
...
** @$>rspec spec/requests/@							- ok (with the set up in 3.6.1 Eliminating bundle exec)
...
* 5.4.3 Had to update Gemfile to use latest point release instead of fixed 'i.j.k' version of following gems
